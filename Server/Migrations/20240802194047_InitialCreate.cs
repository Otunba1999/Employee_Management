        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalDiagonse = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenaralDepartements", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Departments_GenaralDepartements_GeneralDepartmentId",
                        column: x => x.GeneralDepartmentId,
                        principalTable: "GenaralDepartements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
